...
public class Que_2{
	public static void main(String[] args)
	{
		...
		DateDemo d=new DateDemo(4,4,2020);
		d.previusDay();
		d.nextDay();
		d.day();
		System.out.println("= = = = = = = = = = ");
		
		DateDemo d1=new DateDemo(25,5,2022);
		d1.previusDay();
		d1.nextDay();
		d1.day();
		System.out.println("= = = = = = = = = = ");
		
		DateDemo d2=new DateDemo(29,2,2000);
		d2.previusDay();
		d2.nextDay();
		d2.day();
		System.out.println("= = = = = = = = = = ");
		
		DateDemo d3=new DateDemo(31,12,2014);
		d3.previusDay();
		d3.nextDay();
		d3.day();
		System.out.println("= = = = = = = = = = ");
		
		DateDemo d4=new DateDemo(18,9,2005);
		d4.previusDay();
		d4.nextDay();
		d4.day();
		
		System.out.println("= = = = = = = = = = ");
		DateDemo d5=new DateDemo(30,7,2011);
		d5.previusDay();
		d5.nextDay();
		d5.day();
	}	
